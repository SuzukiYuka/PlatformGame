...
public class CameraFollow : MonoBehaviour {
    ...
    void Start() {
        forcusArea = new ForcusArea(target._collider.bounds, forcusAreaSize);
    }

    void LateUpdate() {
        forcusArea.Update(target._collider.bounds);

        Vector2 forcusPosition = forcusArea.center + Vector2.up * verticalOffset;
    ...
    void OnDrawGizmos() {
        ...
        Gizmos.DrawCube(forcusArea.center, forcusAreaSize);
    }
